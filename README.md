...
### Так же прошу обратить Ваше внимание на то, что для Вашего удобства в коде внесенные правки закомментированы в виде "Правка:"
...
2) Избавляет пользователя от повторного ввода
